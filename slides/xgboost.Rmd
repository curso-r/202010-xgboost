...
- Haverá monitoria para esclarecimento de dúvidas sempre 60 minutos antes do início das aulas.
...
- Fora do horário de aula ou monitoria:
  ...
  - perguntas sobre R ou Machine Learning, principalmente as que envolverem código, deverão ser enviadas no [nosso discourse](https://discourse.curso-r.com/).
     
- Se você achar que a resposta para a sua dúvida pode ajudar uma pessoa que não está fazendo o curso, ela deverá ser feita no discourse.
